...
The update process of Jet is contained in the L<Djet::Role::Update> and L<Djet::Role::Update::Node> roles primarily, and there is a
...
Jet uses L<Web::Machine>, and the update process hooks into post_is_create, where it calls edit_update in L<Djet::Role::Update>. If there
